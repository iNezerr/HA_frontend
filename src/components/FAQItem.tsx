...
const FAQItem: React.FC<FAQItemProps> = ({ question, answer, isOpen = false, toggleOpen, id }) => {
      ...
      <h3>
        ...
        >
          ...
          <span className="ml-6 flex-shrink-0">
            {isOpen ? (
              <FiMinus className="h-5 w-5 text-gray-500" aria-hidden="true" />
            ) : (
              <FiPlus className="h-5 w-5 text-gray-500" aria-hidden="true" />
            )}
          </span>
        </button>
      </h3>
