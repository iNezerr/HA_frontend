...
const testimonials = [
  ...
  {
    id: 2,
    text: "Our journey with Hues Apply has been very interesting and promising. Their project is shaping futures and mentoring the youth to achieve their career goals. The Centre for Youth Tech Empowerment and Partnerships (CYTEP) is proud of our partnership and the training provided by Hues Apply.",
    name: "Sophia Amankwa",
    title: "Executive Director, CYTEP",
    image: "/hero/Sophia_Amankwa.jpg",
  },
  {
    id: 3,
    text: "Thanks to Hues Apply for providing such wonderful teaching and helping us learn more about Artificial Intelligence. It has been a great experience.",
    name: "Kusi Adomako Kelvin",
    title: "Computer Systems Engineer",
    image: "/hero/Kusi_Adomako.jpg",
  },
];
